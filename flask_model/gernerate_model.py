...
#使用iris数据生成模型pickle文件
def build_iris_model():
    iris = load_iris()
    var_list=['col1', 'col2', 'col3', 'col4']
    data = pd.DataFrame(iris.data, columns=var_list)
    data['target']=iris.target

    data=data[0:100]
    x_train,x_test,y_train,y_test=train_test_split(data[var_list],data['target'],test_size=0.2,random_state=1)
...
if __name__ == '__main__':
    ...
    with open('model_v1.0.pk','wb') as file:
