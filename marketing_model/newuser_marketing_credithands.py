...
#first_target_dataset=pd.read_excel('/Users/andpay/Documents/job/data/临时活动/信用通循环活动/partfive_userlist.xlsx')
...
#target_dataset=disper_split(first_target_dataset,category_var)
...
# excel_writer=pd.ExcelWriter('/Users/andpay/Documents/job/data/临时活动/信用通循环活动/result_partfive_userlist.xlsx',engine='xlsxwriter')
